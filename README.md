...
| `embedding.onnx` + `vocab.txt` | Multilingual sentence embeddings for semantic harm-category classification (50+ languages, MiniLM, FP32) | ~115 MB | [sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2](https://huggingface.co/sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2) | Apache-2.0 |
